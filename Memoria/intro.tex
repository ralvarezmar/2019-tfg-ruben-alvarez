...
\end{itemize}
%https://gsyc.urjc.es/jmplaza/students/tfg-web_servidor-ignacio_arranz-2017.pdf

%https://gsyc.urjc.es/jmplaza/students/tfg-webtools_jderobot-roberto_perez-2019.pdf
...
\begin{itemize}
    \item \textit{Node.js}: es una forma de ejecutar \textit{JavaScript} en el servidor. O, dicho de otra forma, proporciona un entorno de ejecución del lado del servidor que compila y ejecuta a gran velocidad. Esto es debido a que compila en código máquina nativo en lugar de interpretarlo o ejecutarlo.   
    \item \textit{Django}:
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{img/unimate.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{img/asimo-honda.jpg}
