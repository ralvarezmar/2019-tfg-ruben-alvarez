...
\subsection{Sigue-líneas infrarrojos}
    ...
    En esta solución se comanda una velocidad lineal y se obtienen los valores de los sensores infrarrojos del \textit{robot} y se comanda una velocidad angular en función de donde detecte la línea.
