...
\end{frame}
		...
		\frametitle{Soporte a drones: Bloques Scratch}
		 \begin{minipage}{.45\textwidth}
		       \begin{figure}[H]
            \includegraphics[scale=0.4]{img/ascensionBlockly.png}
           \label{fig:ascension}
            \end{figure}
                 \begin{figure}[H]          \includegraphics[scale=0.4]{img/verticalBlockly.png}
           \label{fig:vertical}
            \end{figure}
            \begin{figure}[H] \includegraphics[scale=0.4,left]{img/aterrizarBlockly.png}
           \label{fig:vertica}
            \end{figure}
               \begin{figure}[H]          \includegraphics[scale=0.4]{img/despegarBlockly.png}
           \label{fig:vertica}
            \end{figure}
               \begin{figure} \includegraphics[scale=0.235]{img/moveAll.png}
                \label{fig:move}
            \end{figure}
            \end{minipage}
            \begin{minipage}{.48\textwidth}
   ...
   \label{fig:mbot}
	  ...
	  \begin{figure}[ht]
       ...
       \begin{figure}
       \begin{subfigure}{\textwidth}
         \href{https://youtu.be/hUb4KdGykbM}
       ...
       \end{subfigure}
       \end{figure}
       \scriptsize{\url{https://youtu.be/hUb4KdGykbM}}
		\end{frame}
