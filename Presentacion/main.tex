...
\begin{document}
	...
	\section{Introducción}
        ...
        \begin{subfigure}{\textwidth}
            \includegraphics[scale=0.12]{img/amazon.png}
        \label{fig:amazon}
        \end{subfigure}\hfill
        \begin{subfigure}{\textwidth}
            \includegraphics[scale=0.12]{img/netflix.png}
        \label{fig:netflix}
        \end{subfigure}\hfill
            \label{fig:appwebs}
            \end{figure}
	...
	\frametitle{WebSim}
	    ...
	    \begin{itemize}
            \begin{itemize}
    	    \item \textit{WebSim} -> simulador robótico  para enseñar conceptos básicos de tecnología, robótica y programación.
	     \end{itemize}{}
	\end{itemize}
\end{frame}
 ...
 \label{fig:f1williams}
   ...
   \label{fig:mbot}
	  ...
	  \begin{figure}[H]
        \centering
        \begin{subfigure}{\textwidth}
            \includegraphics[width=5cm, height=3cm]{img/siguelineas_ir.JPG}
        \label{fig:ir}
        \end{subfigure}
        \begin{subfigure}{\textwidth}
            \includegraphics[width=5cm, height=3cm]{img/pibot_vision.JPG}
        \label{fig:vision}
        \end{subfigure}\hfill
        \begin{subfigure}{\textwidth}
            \includegraphics[width=5cm, height=3cm]{img/bump&go.png}
        \label{fig:chocagira}
        \end{subfigure}
        \begin{subfigure}{\textwidth}
            \includegraphics[width=5cm, height=3cm]{img/cuadradoDrone.png}
        \label{fig:cuadrado}
        \end{subfigure}\hfill
        ...
        \end{subfigure}\hfill
        \begin{subfigure}{\textwidth}
            \includegraphics[width=4cm, height=5cm]{img/siguepelotacodigo.png}
       ...
       \end{subfigure}
       \begin{subfigure}      
       \includegraphics[width=4cm, height=5cm]{img/atraviesaBosqueCodigo.png}
       \end{subfigure}
       \end{figure}
		\end{frame}
		...
		\begin{frame}
			...
			\begin{itemize}\itemsep5pt
			    \item Módulo \textit{\textbf{brains}} ampliado.
			    \item Módulo \textit{\textbf{evaluators}}:
			    \begin{itemize}\itemsep5pt
			        \itemtextit {runEvaluator(arrayRobots,evaluator)}
			    \end{itemize}{}
			    \item Módulo \textit{\textbf{agents}}:
			    \begin{itemize}\itemsep5pt	        \textit{runAgent(idRobot, path)} 
			    \end{itemize}
			\end{itemize}
		\end{frame}
    ...
    \end{minipage}
		\begin{minipage}{.48\textwidth}	
            ...
            \includegraphics[scale=0.18]{img/evaluator_follow_line.png}}
        \end{minipage}
		\end{frame}
	...
	\section{Conclusiones}
		\begin{frame}
			...
			\begin{itemize}
				...
				\item Ejercicios individuales con funcionalidad existente.
				\item Ejercicios competitivos con nueva funcionalidad. 
			\end{itemize}
		\end{frame}
			...
			\begin{itemize}
				\item Nuevos modelos de \textit{robots}.
				\item Nuevos ejercicios.
				\item Gravedad.
				\item \textit{WebWorkers}.
				\item Control en posición.
			\end{itemize}
		\end{frame}
	\appendix
